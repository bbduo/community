...
import com.cwru.platform.entity.Comment;
import com.cwru.platform.entity.DiscussPost;
import com.cwru.platform.entity.Page;
import com.cwru.platform.entity.User;
import com.cwru.platform.service.CommentService;
import com.cwru.platform.service.DiscussPostService;
...
public class DiscussPostsController implements PlatformConstant {
    ...
    public String addDiscussPost(String title, String content) {
        ...
        if (user == null) {
            return PlatformUtil.getJSONString(403, "你还没有登录哦!");
        }
        ...
        // 报错的情况,将来统一处理.
        return PlatformUtil.getJSONString(0, "发布成功!");
    }
