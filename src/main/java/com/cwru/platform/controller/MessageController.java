...
import com.cwru.platform.entity.Message;
import com.cwru.platform.entity.Page;
import com.cwru.platform.entity.User;
import com.cwru.platform.service.MessageService;
...
@Controller
public class MessageController implements PlatformConstant {
    ...
    public String sendLetter(String toName, String content) {
        ...
        if (target == null) {
            return PlatformUtil.getJSONString(1, "目标用户不存在!");
        }
        // 创建一条新的msg
        ...
        return PlatformUtil.getJSONString(0);
    }
    ...
    public String getNoticeList(Model model) {
        ...
        //messageVO是最终显示给前端页面的。
        Map<String, Object> messageVO = new HashMap<>();
        if (message != null) {
            messageVO.put("message", message);
            // JSON 类的content转换成String类。
